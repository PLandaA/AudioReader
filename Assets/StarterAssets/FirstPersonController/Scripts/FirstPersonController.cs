...
namespace StarterAssets {
    ...
    public class FirstPersonController : MonoBehaviour {
        ...
        [SerializeField] Transform debugHitPoint;
        ...
        void HandleHookShotStart () {
            if (_input.grapple) {
                if (Physics.Raycast(cam.transform.position, cam.forward, out RaycastHit hit, maxGrappleLength, whatIsGrappable)) {
        ...
        void HandleHookShotMovement () {
            ...
            _controller.Move(hookshotDir * hookshotSpeed * speedMultiplier * Time.deltaTime);
            float reachedHookshotPositionDistance = 3.0f;
